"""
Diffusion module from velocyto - Pure Python implementation

This is a direct copy from velocyto.py (BSD-2-Clause License)
Original: https://github.com/velocyto-team/velocyto.py

No modifications needed - this module is pure Python with no compiled dependencies.
"""
